<?php include("header.php");?>
            ...
            <h1 class="text-center text-white col-sm-10 mx-auto">Merchant Cash Advance Application</h1>
                    ...
                    <div class="row">
                        ...
                        <div id="preloaded_app-container">
                            ...
                            <form class="form" class="form" method="POST" novalidate="novalidate">
                                    <input type="hidden" value="mca" name="product_name" id="product_name">
                                <div class="row step" id="step0">
                                    <h4 class="text-center">Business Financing Request</h4>
                                <div class="form-group col-md-6 mx-auto">
                                    <label class="mb-1" for="requested_amount">Desired Loan Amount</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fa fa-dollar-sign"></i>
                            </span>
                                <input type="text" id="requested_amount" name="requested_amount" placeholder="Loan Amount" class="form-control digits required" maxlength="6">
                            </div>
                            </div>
                            </div>
                                ...
                                <input type="text" id="postal_code" name="postal_code" placeholder="A9A9A9" class="form-control required validate_postal" disabled="disabled" maxlength="6" minlength="6">
                            </div>
                            </div>
                                <div class="row step" id="step2" style="display: none;"><div class="form-group col-md-6 mx-auto">
                                    <label class="mb-1" for="business_start_date">Business Start Date</label>
                                <input type="text" id="business_start_date" name="business_start_date" placeholder="2012-06-28" class="form-control date start_biz required" disabled="disabled">
                            </div>
                            </div>
                                ...
                                <input type="text" id="first_name" name="first_name" placeholder="First Name" class="form-control required" disabled="disabled"></div>
                                <div class="form-group col-md-6">
