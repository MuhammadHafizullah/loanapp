            ...
            <div class="row preloaded_app panel panel-default mx-auto mt-4 py-4">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <form class="col-md-10 mx-auto form frmbldr-form mortgage_renewal" method="POST" novalidate="novalidate">
                                    <input type="hidden" value="mortgage_renewal" name="product_name" id="product_name">
                        <div class="row step" id="step0" >
                                ...
                                <div class="form-group col-md-6 col-sm-12 mx-auto">
                                    ...
                                    <input type="text" id="postal_code" name="postal_code" placeholder="A9A9A9" class="form-control required validate_postal" maxlength="6" minlength="6" aria-invalid="false">
                                </div>
                        </div>
                            ...
                            <div class="row step" id="step1" style="display: none;">
                                    ...
                                    <select id="title" name="title" class="form-control form-select required">
