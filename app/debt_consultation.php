...
$form_heading="Debt Relief Request";
?>


<h1 class="text-center text-white col-sm-10 mx-auto">Free Debt Settlement Consultation</h1>
            <div class="row preloaded_app panel panel-default mx-auto mt-4 py-4">
                <div class="panel-body">
                    <div class="row">
                        <h2 class='panel-subheading text-center'>
                        Speak With A Debt Pro About Eliminating Your Debt
                        </h2>
