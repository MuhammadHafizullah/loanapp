...
<h1 class="text-center text-white col-sm-10 mx-auto">Mortgage Renewal Request</h1>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div id="preloaded_app-container">
                            ...
                            <input type="hidden" name="product_name" value="mortage_renewal" id="product_name">
